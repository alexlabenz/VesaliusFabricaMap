...
document.addEventListener('DOMContentLoaded', function () {
    ...
    Promise.all([d3.csv('https://alexlabenz.github.io/VesaliusFabricaMap/data/test.csv'),d3.csv('https://alexlabenz.github.io/VesaliusFabricaMap/data/coords_map.csv')])
